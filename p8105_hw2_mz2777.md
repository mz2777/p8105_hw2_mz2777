...
baby_names = read_csv("data/Popular_Baby_Names.csv") %>%
  ...
  mutate(first_name = str_to_lower(first_name)) %>%  #make string variables in lower case over time
  distinct()
```
...
```
    ...
    ##            <dbl> <chr>                      <dbl> <dbl>
    ##  1          2011 ASIAN AND PACIFIC ISLANDER    89     4
    ##  2          2011 BLACK NON HISPANIC            52    10
    ##  3          2011 HISPANIC                      86    18
    ##  4          2011 WHITE NON HISPANIC           213     2
    ##  5          2012 ASIAN AND PACI               132     3
    ##  6          2012 BLACK NON HISP                58     8
    ##  7          2012 HISPANIC                      77    22
    ##  8          2012 WHITE NON HISP               198     4
    ##  9          2013 ASIAN AND PACIFIC ISLANDER   109     3
    ## 10          2013 BLACK NON HISPANIC            64     6
    ## # … with 14 more rows
...
```
    ...
    ## # A tibble: 24 x 4
    ##    year_of_birth ethnicity                  first_name count
    ##            <dbl> <chr>                      <chr>      <dbl>
    ##  1          2011 ASIAN AND PACIFIC ISLANDER Ethan        177
    ##  2          2011 BLACK NON HISPANIC         Jayden       184
    ##  3          2011 HISPANIC                   Jayden       426
    ##  4          2011 WHITE NON HISPANIC         Michael      292
    ##  5          2012 ASIAN AND PACI             Ryan         197
    ##  6          2012 BLACK NON HISP             Jayden       171
    ##  7          2012 HISPANIC                   Jayden       364
    ##  8          2012 WHITE NON HISP             Joseph       300
    ##  9          2013 ASIAN AND PACIFIC ISLANDER Jayden       220
    ## 10          2013 BLACK NON HISPANIC         Ethan        146
    ## # … with 14 more rows
